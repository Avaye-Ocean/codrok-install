...
5. Force-refresh all commands to `~/.claude/commands/` (always latest version)
6. Create a deployment repo `{your-org}-codrok`
7. Register the installation
8. Auto-scaffold the current repo if run from within a git repo
...
(If you ran the installer from inside a repo, that repo is already scaffolded — skip this step.)
...
payload = {"org":"...","iat":"...","exp":"...","kid":"...","v":1,"max_seats":N,"max_repos":M}
```
